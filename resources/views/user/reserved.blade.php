...
@section('content')
    <div class="container-xxl py-5">
        ...
        <div class="row g-0 justify-content-center">
            ...
            <div class="col-md-8 col-lg-6 bg-dark d-flex align-items-center shadow-lg"
                                ...
                                <div class="card mb-2 p-3 border-0 shadow-sm">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <button type="button" class="btn btn-danger btn-sm btn-minus"
                                                data-id="{{ $product->id }}">-</button>

                                            <input type="text" name="products[{{ $product->id }}]" id="qty-{{ $product->id }}"
                                                value="0" class="form-control text-center" style="width:50px" readonly>
