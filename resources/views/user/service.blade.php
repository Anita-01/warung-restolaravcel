            ...
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item rounded pt-3">
                    <div class="p-4">
                        ...
                        <h5>Menu Rumahan</h5>
                        <p>Sajian Bubur Ayam, Nasi Goreng Kampung, dan aneka sayur dengan cita rasa otentik dan halal.</p>
                    </div>
                </div>
            </div>
            <!-- Akurasi Pesanan -->
            ...
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                <div class="service-item rounded pt-3">
                    <div class="p-4">
                        ...
                        <h5>Jasa Katering</h5>
                        <p>Melayani pesanan katering untuk acara kantor atau keluarga dengan manajemen data yang rapi.</p>
                    </div>
                </div>
            </div>
        </div>
